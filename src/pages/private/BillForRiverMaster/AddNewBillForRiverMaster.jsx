...
function AddNewBillForRiverMaster() {
  return (
    <>
      <Header
        title="Add New Bill"
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr className="bg-gray-200 border-b ">
              ...
              <td className="px-6 py-4">678.67</td>
              <td className="px-6 py-4">678.67</td>
              <td className="px-6 py-4"> <button className={btn} >Download</button></td>
              <td className="px-6 py-4 flex">
                <TrashIcon className="h-5 w-5" /> <PencilSquareIcon className="h-5 w-5 ms-2" />
              </td>
              <td className="px-6 py-4"> <Link to='/VarifyBillForRiverMaster'> <button className={btn} >Varify</button></Link></td>
...
export default AddNewBillForRiverMaster;
