...
function BillForRiverMaster() {
  return (
    <>
      <Header
        title="Varified Monthly Bill for River Pollution Control Unit Master"
        action={{
          button: "",
          path: "",
        }}
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr className="bg-gray-200 border-b ">
              ...
              <td className="px-6 py-4">678.67</td>              
              <td className="px-6 py-4">678.67</td>              
              <td className="px-6 py-4"> <Link to='/AddNewBillForRiverMaster'> <button className={btn} >Add New</button></Link></td>
...
export default BillForRiverMaster;
