...
function BillForJalSansthan() {
  return (
    <>
      <Header
        title="Varified Monthly Bill for Jal Sansthan"
        action={{
          button: "",
          path: "",
        }}
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr className="bg-gray-200 border-b ">
              ...
              <td className="px-6 py-4">678.67</td>              
              <td className="px-6 py-4">678.67</td>              
              <td className="px-6 py-4"> <Link to='/AddNewBillForJalSansthan'> <button className={btn} >Add New</button></Link></td>
...
export default BillForJalSansthan;
