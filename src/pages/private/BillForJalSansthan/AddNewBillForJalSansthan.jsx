...
function AddNewBillForJalSansthan() {
  return (
    <>
      <Header
        title="Add New Bill"
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr className="bg-gray-200 border-b ">
              ...
              <td className="px-6 py-4"> <Link to='/VarifyBillForJalSansthan'> <button className={btn} >Varify</button></Link></td>
...
export default AddNewBillForJalSansthan;
