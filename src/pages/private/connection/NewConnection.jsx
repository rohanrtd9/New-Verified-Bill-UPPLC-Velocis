...
<div className="mt-8 max-w-xxl p-6 bg-gray-200 border border-gray-200 rounded-lg shadow mx-auto">
    ...
    <div className="relative z-0 w-full col-md-4 mb-4 group">
        <input type="text" name="floating_first_name" id="floating_first_name" className={input} placeholder=" " required />
        <label  className={label} >Bill For</label>
    </div>
    <div className="relative z-0 w-full col-md-4 mb-4 group">
        <input type="date" name="floating_last_name" id="floating_last_name" className={input} placeholder=" " required />
    ...
    <div className="relative z-0 w-full col-md-4 mb-4 group">
        <input type="text" name="floating_last_name" id="floating_last_name" className={input} placeholder=" " required />
    ...
    <div className="relative z-0 w-full col-md-8 mb-4 group flex">
      ...
      <div className="w-2/6">
          ...
          <label  className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Online</label>
      </div>
      <div className="w-2/6">
          ...
          <label  className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Offline</label>
      </div>
    </div>
    ...
    <div className="relative z-0 w-full col-md-8 mb-4 group flex">
      ...
      <div className="w-2/6">
          <input id="inline-radio" type="radio" value="" name="billing-type" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
          <label  className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">RDPDRP</label>
      </div>
      <div className="w-2/6">
          <input id="inline-2-radio" type="radio" value="" name="billing-type" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
          <label  className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Non-RDPDRP</label>
      </div>
    </div>
