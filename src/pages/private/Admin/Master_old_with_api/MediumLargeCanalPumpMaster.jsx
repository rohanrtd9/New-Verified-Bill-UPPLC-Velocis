...
function MediumLargeCanalPumpMaster() {
  return (
    <>
      <Header
        title="Medium and Large Pump Canal Master"
        action={{
          button: "",
          path: "",
        }}
        ...
        <div className="grid md:grid-cols-2 md:gap-6">
          <div className="relative z-0 w-full col-md-4 mb-4 group">
            ...
            <select id="countries" className={select}>
              ...
              <option defaultValue="EDD Chunar">EDD Chunar</option>
            </select>
          </div>

          <div className="relative z-0 w-full col-md-4 mb-4 group">
            <label className={label}>Medium and Large Pump Canal Name</label>
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              ...
              <th scope="col" className="px-6 py-3">
                Medium and Large Pump Canal Name
              </th>
          ...
          <tbody>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4">EDD Chunar</td>
              <td className="px-6 py-4">Dhoba</td>
...
export default MediumLargeCanalPumpMaster;
