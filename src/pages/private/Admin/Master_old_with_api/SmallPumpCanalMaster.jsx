        ...
        <div className="grid md:grid-cols-2 md:gap-6">
          <div className="relative z-0 w-full col-md-4 mb-4 group">
            ...
            <select id="countries" className={select}>
              ...
              <option defaultValue="Aloo Mandi">Aloo Mandi</option>
            </select>
          </div>

          <div className="relative z-0 w-full col-md-4 mb-4 group">
            <label className={label}>Small Pump Canal Master</label>
...
export default SmallPumpCanalMaster;
