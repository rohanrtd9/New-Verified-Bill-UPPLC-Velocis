        ...
        <div className="grid md:grid-cols-2 md:gap-6">
          <div className="relative z-0 w-full col-md-4 mb-4 group">
            ...
            <select id="countries" className={select}>
              ...
              <option defaultValue="Daliganj">Daliganj</option>
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4">Daliganj</td>
              <td className="px-6 py-4">Lucknow Jal Sansthan</td>
...
export default JalSansthanMaster;
